...
+ (UINib *)nib
{
    return [UINib nibWithNibName:NSStringFromClass([BaseMessagesViewController class])
                          bundle:[NSBundle bundleForClass:[BaseMessagesViewController class]]];
}

+ (instancetype)messagesViewController
{
    return [[[self class] alloc] initWithNibName:NSStringFromClass([BaseMessagesViewController class])
                                          bundle:[NSBundle bundleForClass:[BaseMessagesViewController class]]];
}

+ (void)initialize {
    [super initialize];
    if (self == [BaseMessagesViewController self]) {
